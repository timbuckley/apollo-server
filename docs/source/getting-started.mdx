...
JavaScript and have installed a recent Node.js (v16.19.1+) version. Additionally, for those interested, this tutorial includes an optional section describing how to set up Apollo Server with TypeScript.
